...
To remove the build artifacts and cache files generated by the test runs, run:
...
The software (i.e. all code inside the `test` and `util` directories) is licensed under the
